...
int main()
{
    ...
    std::cout << "Lastimosamente se puede decir que no han habido muchos cambios en cuanto a tecnologia, ni existen coches voladores como soliamos pensar. Si es triste.\n";
    std::cout << "Bueno, aqui nos encontramos contigo " << nombre << ". Te encuentras en tu automovil, en medio del trafico. Acabas de regresar de una tranquila visita al sementerio\n";
